...
function cmb_slider($field, $meta) {
    ...
    global $post;
        ...
        wp_localize_script('cmbslider-admin-script', 'cmbSliderData', array(
            ...
            'edit_image' =>  __( 'Edit image', 'cmbslider' ) ,
            'delete_image' =>  __( 'Delete image', 'cmbslider' ) ,
        ...
        echo '<ul class="attach_list_gallery" id="attach-list', $field['id'], '"></ul>';
                  ...
                  <div  id="cmb-attachment-form"  class="media-sidebar" style="position:static;width:84%;background:transparent;border:none;">
                      <label class="setting" data-setting="title">
                        ...
                        <div class="media-toolbar-primary">
                            <a id="cmb-save-att-button"  style="color:#FFF;" class="button media-button button-primary button-large media-button-select">',  _e( 'Save', 'cmbslider' ) , '</a>
