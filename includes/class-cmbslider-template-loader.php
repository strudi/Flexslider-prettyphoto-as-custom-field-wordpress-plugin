...
class CMB_Slider_Template_Loader extends Gamajo_Template_Loader {
	 ...
	 * @type string
	 */
	protected $filter_prefix = 'cmb_slider';
	 ...
	 * @type string
	 */
	protected $theme_template_directory = 'cmb_slider';
	 ...
	 * @type string
	 */
	protected $plugin_directory = CMB_SLIDER_PLUGIN_DIR;
